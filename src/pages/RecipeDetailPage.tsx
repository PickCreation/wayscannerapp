  ...
  return (
    <div className="pb-6 bg-white min-h-screen">
      ...
      <div className="px-4">
        <Tabs defaultValue="ingredients" value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="ingredients" className="mt-4">
            <h3 className="text-base font-semibold mb-3 flex items-center text-left">
      ...
      <div className="px-4 mt-6">
        <h3 className="text-base font-semibold mb-3 text-left">Nutrition Information</h3>
      ...
      <div className="px-4 mt-6">
        <h3 className="text-base font-semibold mb-3 text-left">Tips</h3>
        <div className="bg-yellow-50 border border-yellow-100 rounded-lg p-4">
          <div className="flex items-start mb-2">
            <LightbulbIcon size={14} className="text-yellow-500 mr-2 mt-0.5" />
            <h4 className="text-sm font-semibold text-yellow-600 text-left">Chef Tips</h4>
          </div>
      ...
      <div className="px-4 mt-6">
        <div className="flex justify-between items-center mb-3">
          <div className="flex items-center">
            ...
            <h3 className="text-base font-semibold text-left">Comments ({allComments.length})</h3>
          </div>
          <button 
        ...
        <div className="mt-4">
          <h3 className="text-base font-semibold mb-4 text-left">Add Your Comment</h3>
      ...
      <Drawer open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
        <DrawerContent className="p-4 max-h-[90vh]">
          <DrawerHeader className="relative">
            <DrawerTitle className="text-left">All Comments ({allComments.length})</DrawerTitle>
